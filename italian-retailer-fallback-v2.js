...
async function run(force=false){
  ...
  try{
    ...
    if(needPlot&&plots[0]){const safe=cleanPlotGlobal(plots[0].plot);if(safe){plot.value=safe;plot.dispatchEvent(new Event('input',{bubbles:true}))}}
