...
if(root.__LIB_SERIES_NEIGHBORS_STANDALONE_V25)return;root.__LIB_SERIES_NEIGHBORS_STANDALONE_V25=true;
...
loadOnce('libGenreGoodreadsOnlyV10','goodreads-genres-v1.js?v=20260819-10');
root.__LIB_GENRE_SOURCE_POLICY='goodreads-only';
root.__LIB_SERIES_NEIGHBORS_V25_TEST__={safeSaga,safeBook};
})();