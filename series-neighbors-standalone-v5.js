...
if(root.__LIB_SERIES_NEIGHBORS_STANDALONE_V32)return;root.__LIB_SERIES_NEIGHBORS_STANDALONE_V32=true;
...
loadOnce('libPublisherPlotResilienceV4','publisher-plot-resilience-v4.js?v=20260819-4');
...
loadOnce('libGenreWhitelistV1','genre-whitelist-v1.js?v=20260820-1');
root.__LIB_GENRE_SOURCE_POLICY='storygraph-then-goodreads-whitelist';
root.__LIB_PLOT_SOURCE_POLICY='publisher-first-then-clean-fallbacks';
root.__LIB_SERIES_NEIGHBORS_V32_TEST__={safeSaga,safeBook};
})();
