...
if(root.__LIB_SERIES_NEIGHBORS_STANDALONE_V23)return;root.__LIB_SERIES_NEIGHBORS_STANDALONE_V23=true;
...
function safeBook(v,title=''){let x=clean(v).replace(/^["“”«»']+|["“”«»']+$/g,'').replace(/[.;:\s]+$/,'');const n=norm(x);if(!x||x.length>190||n===norm(title)||/https?:|www\.|\.{2,}|…|[{}<>]/.test(x)||/\b(?:isbn|ean|editore|publisher|autore|author|followed by|preceded by|iniziat[ao] con|seguit[oa] da|pubblicat[ao] nel)\b/i.test(n)||/\b(?:she|he|they|we|you)\s+(?:is|are|was|were|has|have|had|got|will|would|can|could)\b/i.test(n))return'';return x}
...
loadOnce('libGenreDelegateV8','goodreads-genres-v1.js?v=20260819-8');
...
loadOnce('libGenreSearchFallbackV2','genre-search-fallback-v1.js?v=20260819-2');
loadOnce('libGenreOpenLibraryWorkV1','genre-openlibrary-work-v1.js?v=20260819-1');
root.__LIB_SERIES_NEIGHBORS_V23_TEST__={safeSaga,safeBook};
})();