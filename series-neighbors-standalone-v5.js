...
if(root.__LIB_SERIES_NEIGHBORS_STANDALONE_V26)return;root.__LIB_SERIES_NEIGHBORS_STANDALONE_V26=true;
...
loadOnce('libGenreStoryGraphGoodreadsV1','storygraph-goodreads-genres-v1.js?v=20260819-1');
root.__LIB_GENRE_SOURCE_POLICY='storygraph-then-goodreads';
root.__LIB_SERIES_NEIGHBORS_V26_TEST__={safeSaga,safeBook};
})();