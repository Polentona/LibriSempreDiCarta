...
if(root.__LIB_SERIES_NEIGHBORS_STANDALONE_V31)return;root.__LIB_SERIES_NEIGHBORS_STANDALONE_V31=true;
...
root.__LIB_GENRE_SOURCE_POLICY='storygraph-then-goodreads';
root.__LIB_PLOT_SOURCE_POLICY='publisher-first-then-clean-fallbacks';
root.__LIB_SERIES_NEIGHBORS_V31_TEST__={safeSaga,safeBook};
})();