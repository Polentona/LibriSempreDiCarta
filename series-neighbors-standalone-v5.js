...
if(root.__LIB_SERIES_NEIGHBORS_STANDALONE_V24)return;root.__LIB_SERIES_NEIGHBORS_STANDALONE_V24=true;
...
loadOnce('libGenreGoodreadsOnlyV9','goodreads-genres-v1.js?v=20260819-9');
root.__LIB_GENRE_SOURCE_POLICY='goodreads-only';
root.__LIB_SERIES_NEIGHBORS_V24_TEST__={safeSaga,safeBook};
})();