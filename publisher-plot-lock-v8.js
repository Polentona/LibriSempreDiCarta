...
const official=typeof root.__LIB_RESOLVE_OFFICIAL_PLOT==='function'?root.__LIB_RESOLVE_OFFICIAL_PLOT:null;
...
boot();root.__LIB_PLOT_SOURCE_POLICY='publisher-first-official-retry-lock-v8';root.__LIB_PUBLISHER_PLOT_LOCK_V8_TEST__={noise,enforce};
})();
